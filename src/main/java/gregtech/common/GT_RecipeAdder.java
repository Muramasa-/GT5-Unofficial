...
public class GT_RecipeAdder
    ...
    @Override
    public boolean addFusionReactorRecipe(FluidStack aInput1, FluidStack aInput2, FluidStack aOutput1, FluidStack aCoolantOutput, int aDuration, int aEUt, int aStartEU) {
        if (aInput1 == null || aInput2 == null || aOutput1 == null || aDuration < 1 || aEUt < 1 || aStartEU < 1) {
            return false;
        }
        GT_Recipe.GT_Recipe_Map.sFusionRecipes.addRecipe(null, new FluidStack[]{aInput1, aInput2}, new FluidStack[]{aOutput1, aCoolantOutput}, aDuration, aEUt, aStartEU);
        return true;
    }
...
//        
    ...
    public boolean addHPFurnaceRecipe(FluidStack aInput1, FluidStack aInput2, FluidStack aOutput1, FluidStack aOutput2, int aDuration, int aEUt) {
        ...
        if ((aDuration = GregTech_API.sRecipeFile.get("hpfurnace", aInput1.getUnlocalizedName(), aDuration)) <= 0) {
            return false;
        }
        GT_Recipe.GT_Recipe_Map.sHPFurnaceRecipes.addRecipe(false, null, null, null, new FluidStack[]{aInput1, aInput2}, new FluidStack[]{aOutput1, aOutput2}, Math.max(1, aDuration), Math.max(1, aEUt), 0);
        return false;
    }
}
