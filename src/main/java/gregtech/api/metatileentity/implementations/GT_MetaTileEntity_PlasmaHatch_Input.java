...
public class GT_MetaTileEntity_PlasmaHatch_Input extends GT_MetaTileEntity_Hatch {
    public GT_Recipe.GT_Recipe_Map mRecipeMap = null;

    public GT_MetaTileEntity_PlasmaHatch_Input(int aID, String aName, String aNameRegional, int aTier) {
        super(aID, aName, aNameRegional, aTier, 3, "Plasma Input for Multiblocks (" + 8000 * (aTier + 1) + "L)");
    }

    public GT_MetaTileEntity_PlasmaHatch_Input(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_PlasmaHatch_Input(mName, mTier, mDescription, mTextures);
    }
