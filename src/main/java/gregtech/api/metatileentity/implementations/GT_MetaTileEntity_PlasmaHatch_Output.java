...
public class GT_MetaTileEntity_PlasmaHatch_Output extends GT_MetaTileEntity_Hatch {
    public byte mMode = 0;

    public GT_MetaTileEntity_PlasmaHatch_Output(int aID, String aName, String aNameRegional, int aTier) {
        super(aID, aName, aNameRegional, aTier, 3, "Plasma Output for Multiblocks (" + 8000 * (aTier + 1) + "L) (Screwdriver for output type)");
    }

    public GT_MetaTileEntity_PlasmaHatch_Output(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_PlasmaHatch_Output(mName, mTier, mDescription, mTextures);
    }
