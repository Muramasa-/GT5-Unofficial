...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sHPFurnaceRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(50), "gt.recipe.hpfurnace", "High Pressure Furnace", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 1, 1, E, 1, E, true, true);
