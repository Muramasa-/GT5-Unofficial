...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sFusionRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(50), "gt.recipe.fusionreactor", "Fusion Reactor", null, RES_PATH_GUI + "basicmachines/Default", 0, 0, 0, 3, 1, "Start: ", 1, " EU", true, true);
        ...
        public static final GT_Recipe_Map sHighPressureFurnaceRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(50), "gt.recipe.highpressurefurnace", "High Pressure Furnace", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, E, 1, E, true, true);
